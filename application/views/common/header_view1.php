...
<head>
    ...
    <link rel="icon" href="<?=base_url() ?>Assets/images/logo2.png" sizes="32x32" type="image/png">
...
<body>
    ...
    <div class="app-admin-wrap layout-sidebar-large">
        <div class="main-header  ">
            ...
            <div style="margin: auto"><h1 class="text-center headinginheader" style="font-family: 'Work Sans', sans-serif;">I Care Optical</h1></div>
        ...
        <div class="side-content-wrap">
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <li class="nav-item"><span class="item-name_tittle" >Remarks</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Remark/create"><i class=" nav-icon fa-solid fa-graduation-cap" ></i><span class="item-name">Remarks</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Remark/index"><i class=" nav-icon fa-solid fa-graduation-cap" ></i><span class="item-name">Remarks Details</span></a></li>
                   
                </ul>

                <ul class="childNav" data-parent="extrakits3">
                    <li class="nav-item"><span class="item-name_tittle" >Use</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Useoptical/create"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Use</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Useoptical/index"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Use Details</span></a></li>                 
                </ul>

                <ul class="childNav" data-parent="extrakits4">
                    <li class="nav-item"><span class="item-name_tittle" >Type</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Type/create"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Type</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Type/index"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Type details</span></a></li> 
                   
                </ul>

                <ul class="childNav" data-parent="extrakits5">
                    <li class="nav-item"><span class="item-name_tittle" >Unit</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Unit/create"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Unit</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Unit/index"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Unit details</span></a></li> 
                   
                </ul>

                <ul class="childNav" data-parent="extrakits6">
                    <li class="nav-item"><span class="item-name_tittle" >Glasstype</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Glasstype/create"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Glasstype</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Glasstype/index"><i class="nav-icon fa-solid fa-person-chalkboard"></i><span class="item-name">Glasstype details</span></a></li> 
