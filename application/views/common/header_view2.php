...
<body onload="myFunction1();">
    ...
    <div class="app-admin-wrap layout-sidebar-large">
        <div class="main-header  ">
            ...
            <img src="<?=base_url();?>Assets/images/img1.JPEG" alt="" style="height:48px;width:100%;"></h1></div>
        ...
        <div class="side-content-wrap">
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <ul class="childNav" data-parent="extrakitsdashborded">
                    <!-- <li class="nav-item"><span class="item-name_tittle" >Dashbord</span></li> -->
                    <li class="nav-item"><a href="<?=base_url() ?>Dashboard"><i class="nav-icon fa-solid fa-table-columns"></i><span class="item-name">Dashbord</span></a></li>
                </ul>

                <ul class="childNav" data-parent="extrakits1">
                <li class="nav-item"><span class="item-name_tittle" >ICare</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Shop/create"><i class="nav-icon fa-solid fa-square-plus"></i></i><span class="item-name">ICare Opticals </span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Shop/index"><i class="nav-icon fa-solid fa-table"></i></i><span class="item-name">Opticals Details</span></a></li>
                   
                </ul>


                <ul class="childNav" data-parent="report">
                <li class="nav-item"><span class="item-name_tittle" >Report</span></li>
                ...
                <li class="nav-item"><span class="item-name_tittle" >Remarks</span></li>
                ...
                <ul class="childNav" data-parent="extrakits3">
                    <li class="nav-item"><span class="item-name_tittle" >Use</span></li>
                ...
                <ul class="childNav" data-parent="extrakits4">
                    <li class="nav-item"><span class="item-name_tittle" >Type</span></li>
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Type/index"><i class="nav-icon fa-solid fa-window-restore"></i><span class="item-name">Type details</span></a></li> 
                   
                </ul>

                <ul class="childNav" data-parent="extrakits5">
                    <li class="nav-item"><span class="item-name_tittle" >Unit</span></li>
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Unit/index"><i class="nav-icon fa-solid fa-window-restore"></i><span class="item-name">Unit details</span></a></li> 
                   
                </ul>

                <ul class="childNav" data-parent="extrakits6">
                    <li class="nav-item"><span class="item-name_tittle" >Glasstype</span></li>
                    <li class="nav-item"><a href="<?=base_url();?>Glasstype/create"><i class="nav-icon fa-solid fa-glasses"></i><span class="item-name">Glasstype</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Glasstype/index"><i class="nav-icon fa-solid fa-window-restore"></i><span class="item-name">Glasstype details</span></a></li> 
