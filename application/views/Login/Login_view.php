...
<head>
    ...
    <link rel="icon" href="<?=base_url() ?>Assets/images/Eye1.png" sizes="32x32" type="image/png">
    ...
    <style>
        ...
        body{
            ...
            align-items: center;
            min-height:100vh;
            background-image: url('<?=base_url() ?>Assets/images/Eye.jpg');
    ...
    <div class="wrapper">
        <form role="form" id="Form" action="" method="post" >
            ...
            <div class="register-Link">
                <p style="color:#383634;">Designed & Developed By<a href=""> Asif Mulla</a></p>
            </div>
        </form>
    </div>
